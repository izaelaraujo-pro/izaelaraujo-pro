...
Sou universitário em Análise e Desenvolvimento de Sistemas pela UNISUAM, com grande interesse nas áreas de Ciência de Dados, Engenharia de Dados, Análise de Dados e Inteligência Artificial.

Venho de uma base em desenvolvimento full-stack, e estou expandindo meus horizontes para o universo dos dados: desde o tratamento e engenharia até a construção de modelos preditivos e soluções com IA aplicada.

## TECNOLOGIAS E FERRAMENTAS :computer:
![enter image description here](https://img.icons8.com/color/64/microsoft-excel-2019.png) ![enter image description here](https://img.icons8.com/?size=64&id=qYfwpsRXEcpc&format=png) ![enter image description here](https://images.icon-icons.com/2415/PNG/64/mysql_original_wordmark_logo_icon_146417.png) ![enter image description here](https://img.icons8.com/?size=64&id=13441&format=png) ![enter image description here](https://img.icons8.com/color/64/amazon-web-services.png)
